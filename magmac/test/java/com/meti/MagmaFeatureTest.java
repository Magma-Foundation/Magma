...
public class MagmaFeatureTest {
    ...
    void definitionConst() {
        assertMagmaFunctionStatements(renderMagmaDefinition(CONST_KEYWORD_WITH_SPACE, TEST_LOWER_SYMBOL, I16_TYPE, TEST_NUMERIC));
    }

    @Test
    void definitionPub() {
        assertMagmaFunctionStatements(renderMagmaDefinition(PUB_KEYWORD_WITH_SPACE, CONST_KEYWORD_WITH_SPACE, TEST_LOWER_SYMBOL, I16_TYPE, TEST_NUMERIC));
    }
