#ifndef Compiler_H
#define Compiler_Himport { ArrayList }import { Arrays }import { List }import { Optional }import { Collectors }from java.utilfrom java.utilfrom java.utilfrom java.utilfrom java.util.streampublic record Compiler(String input, String sourceExtension, String targetExtension) {
