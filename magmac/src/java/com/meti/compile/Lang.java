...
public class Lang {
    ...
    public static final FirstCharRule JAVA_DEFINITION = new FirstCharRule(VALUE_SEPARATOR,
    ...
    public static final OrRule LEFT1 = new OrRule(new RequireRightSlice(" ", new StringListRule("modifiers", " ")), new EmptyRule());
    ...
    public static final FirstRule MAGMA_FUNCTION = new FirstRule(TEMP_SEPARATOR, new FirstRule(CLASS_KEYWORD_WITH_SPACE + DEF_KEYWORD_WITH_SPACE, LEFT1, new StringRule("name")), new RequireLeft(' ', BLOCK));
}
