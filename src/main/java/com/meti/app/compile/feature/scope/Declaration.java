...
public class Declaration extends Definition {
    public Declaration(String name, Node type, Flag... flags) {
        this(new RootText(name), type, flags);
    }

    public Declaration(Input name, Node type, Flag... flags) {
        this(name, type, List.apply(flags));
    }

    public Declaration(Input name, Node type, List<Flag> flags) {
