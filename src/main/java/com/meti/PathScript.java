...
public class PathScript implements Script {
    private final Path path;

    public PathScript(Path path) {
        this.path = path;
    }

    private Path extend(String name, String extension) {
    ...
    @Override
    public void write(Output output) throws ApplicationException {
        try {
