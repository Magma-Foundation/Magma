...
export class ImmutableCompileState implements CompileState {
	...
	sources: List<Source>;
	platform: Platform;
	constructor (imports: List<Import>, output: string, structureNames: List<string>, depth: number, definitions: List<Definition>, findCurrentLocation: Option<Location>, sources: List<Source>, platform: Platform) {
