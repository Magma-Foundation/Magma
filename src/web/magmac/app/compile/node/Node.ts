...
export interface Node {iterNodes() : Iter<Tuple2<String, Node>>;display() : String;
	format(depth : int) : String;iterNodeLists() : Iter<Tuple2<String, NodeList>>;value) : String;
	findString(key : String) : Option<String>;
	merge(other : Node) : Node;
	is(type : String) : boolean;
	retype(type : String) : Node;values) : NodeList;
	findNodeList(key : String) : Option<NodeList>;value) : Node;
