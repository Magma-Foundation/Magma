...
export interface Node {
	...
	withNodeListSerialized(key : String, list : List<T>) : Node {return this.withNodeListAndSerializer( key, list, Serializable.serialize);;}
	withNodeSerialized(key : String, element : T) : Node {return this.withNodeAndSerializer( key, element, Serializable.serialize);;}
