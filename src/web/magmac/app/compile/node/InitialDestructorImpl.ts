...
export class InitialDestructorImpl {
	InitialDestructorImpl : public;
	withNodeList : CompoundDestructor<List<T>>;
	withString : CompoundDestructor<String>;
	withNode : CompoundDestructor<T>;
	complete : CompileResult<T>;
}
