export class SymbolFilter {
	...
	public test( input : String) : boolean { let length : var=input.length( );if(true){ return false;;} let i : var=0;if(true){  let c : var=input.charAt( i);if(true){ i++;continue;;}return false;;}return true;;}
