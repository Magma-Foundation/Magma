...
export class OrRule {
	...
	foldAll(mapper : Function<Rule, CompileResult<T>>, context : Context) : CompileResult<T> {ruleIter : var=this.rules.iter( );initial : var=new OrState<T>( );return ruleIter.fold( initial, 0).toResult( context);;}
