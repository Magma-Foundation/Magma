...
export class TypescriptRules {
	public static createRule() : Rule {return new TypeRule( "root", CommonLang.Statements( "children", new OrRule( Lists.of( JavaRules.createWhitespaceRule( ), TypescriptRules.createImportRule( ), TypescriptRules.createStructureRule( "class"), TypescriptRules.createStructureRule( "interface")))));;}
	private static createStructureMemberRule() : Rule { let definitionRule : var=TypescriptRules.createDefinitionRule( ); let valueLazy : LazyRule=new MutableLazyRule( );return new OrRule( Lists.of( JavaRules.createWhitespaceRule( ), TypescriptRules.createMethodRule( definitionRule, valueLazy), JavaStructureStatement.createStructureStatementRule( definitionRule, valueLazy)));;}
