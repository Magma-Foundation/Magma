...
export class Values {
	deserializeOrError(node : Node) : CompileResult<JavaValue> {return 0;;}
	deserialize(node : Node) : Option<CompileResult<JavaValue>> {break;break;return 0;;}
	getWrap(operator : Operator) : TypedDeserializer<JavaValue> {return 0;;}
