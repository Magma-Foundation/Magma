...
export class FunctionSegmentValues {
	deserialize(node : Node) : CompileResult<JavaFunctionSegmentValue> {return Deserializers.orError( "function-segment-value", node, Lists.of( Deserializers.wrap( JavaDeserializers.deserializeReturn), Deserializers.wrap( JavaAssignmentNode.deserialize), Deserializers.wrap( JavaDeserializers.deserializeInvocation), Deserializers.wrap( 0), Deserializers.wrap( 0), Deserializers.wrap( JavaDeserializers.deserializeBreak), Deserializers.wrap( JavaDeserializers.deserializeContinue), Deserializers.wrap( JavaDeserializers.deserializeYield)));;}
	createFunctionSegmentValueRule(value : Rule, definition : Rule) : Rule {return new OrRule( Lists.of( JavaRules.createInvokableRule( value), JavaAssignmentNode.createAssignmentRule( definition, value), JavaRules.createReturnRule( value), JavaRules.createYieldRule( value), JavaPost.createPostRule( "post-increment", "++", value), JavaPost.createPostRule( "post-decrement", "--", value), new TypeRule( "break", new ExactRule( "break")), new TypeRule( "continue", new ExactRule( "continue"))));;}
}
