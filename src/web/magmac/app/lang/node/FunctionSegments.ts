...
export class FunctionSegments {
	deserialize(node : Node) : CompileResult<JavaFunctionSegment> {return 0.orError( "function-segment", 0, 0.of( 0.wrap( 0.deserializeWhitespace), 0.wrap( 0.deserializeFunctionStatement), 0.wrap( 0.deserializeBlock), 0.wrap( 0.deserializeReturn), 0.wrap( 0.deserialize)));;}
	initFunctionSegmentRule(functionSegmentRule : LazyRule, value : Rule, definition : Rule) : Rule {break;break;return 0.set( new StripRule( "before", 0, ""));;}
}
