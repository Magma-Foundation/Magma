...
export class InvocationFolder {
	fold(state : DivideState, c : char) : DivideState {break;if(true){ return appended.enter( ).advance( );;}if(true){ return appended.enter( );;}if(true){ return appended.exit( );;}return appended;;}
