...
export class FlattenJava {
	getChildren(state : ParseState, node : Node) : InlinePassResult {break;return 0;;}
	pass(state : ParseState, node : Node) : ParseResult {if(true){ break;return 0;;}if(true){ return 0;;}return 0;;}
}
