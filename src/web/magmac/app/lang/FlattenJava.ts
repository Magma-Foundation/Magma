...
export class FlattenJava {
	...
	pass(state : ParseState, node : Node) : ParseResult {if(true){ break;return 0.getChildren( 0, 0.withNodeList( 0, 0));;}if(true){ return 0.getChildren( 0, 0.retype( 0));;}return 0.empty( );;}
}
