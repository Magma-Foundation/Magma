...
export class TypeSeparatorFolder {
	fold(state : DivideState, c : char) : DivideState {if(true){ return state.advance( );;}appended : DivideState=state.append( c);if(true){ return appended.enter( );;}if(true){ return appended.exit( );;}return appended;;}
