...
export class TypeSeparatorFolder {
	fold(state : DivideState, c : char) : DivideState {if(true){ return state.advance( );;}break;if(true){ return appended.enter( );;}if(true){ return appended.exit( );;}return appended;;}
