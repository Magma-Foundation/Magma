...
export class JavaStructureNode {
	JavaStructureNode(type : JavaLang.JavaStructureType, structureNode : StructureValue<JavaLang.JavaType, JavaStructureMember>, parameters : Option<List<JavaParameter>>, variants : Option<List<JavaLang.JavaType>>) : public {this.type=type;this.value=structureNode;this.parameters=parameters;this.variants=variants;;}
