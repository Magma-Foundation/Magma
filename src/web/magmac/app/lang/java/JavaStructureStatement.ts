...
export class JavaStructureStatement {
	...
	createStructureStatementRule(definitionRule : Rule, valueRule : LazyRule) : Rule {definition : Rule=new NodeRule( "value", new OrRule( Lists.of( definitionRule, JavaRules.createAssignmentRule( definitionRule, valueRule))));return new TypeRule( "structure-statement", new StripRule( new SuffixRule( definition, ";")));;}
}
