...
export class PathSources {
	getTuple2IOResult(source : PathSource) : IOResult<Unit<String>> {return 0;;}
	readAll() : IOResult<UnitSet<String>> {return 0;;}
	apply(sources : Iter<Path>) : IOResult<UnitSet<String>> {return 0;;}
	getCollect(sources : Iter<Path>) : Result<UnitSet<String>, IOException> {return 0;;}
	getCollected(sources : Iter<Path>) : List<PathSource> {return 0;;}
}
