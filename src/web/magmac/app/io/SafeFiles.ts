...
export class SafeFiles {
	writeString(target : Path, output : String) : Option<IOException> {if(true){ break;return 0;;}if(true){ return 0;;};}
	...
	createDirectories(targetParent : Path) : Option<IOException> {if(true){ break;return 0;;}if(true){ return 0;;};}
}
