...
export class JVMList<T> {
	JVMList() : public {0F( 0);;}
	addLast(element : T) : List<T> {break;0F( 0);return 0;;}
	...
	sort(sorter : BiFunction<T, T, Integer>) : List<T> {break;0F( 0);return 0;;}
	...
	addFirst(element : T) : List<T> {break;0F( 0);0F( 0);return 0;;}
