...
export class JVMList<T> {
	JVMList() : public {0( 0);;}
	addLast(element : T) : List<T> {break;0( 0);return 0;;}
	...
	sort(sorter : BiFunction<T, T, Integer>) : List<T> {break;0( 0);return 0;;}
	...
	addFirst(element : T) : List<T> {break;0( 0);0( 0);return 0;;}
