...
export declare function isEmpty(cache: string): boolean;
export declare function equalsTo(left: string, right: string): boolean;
export declare function strip(input: string): string;
