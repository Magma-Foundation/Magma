...
/* @Override
        public */ removeLast();
Option < [(List), T] > {
    : /* : Tuple2 */ .elements /* : unknown */.isEmpty /* : unknown */() /* : unknown */
};
{
    return new None() /* : None */;
}
...
Iterator < [number, T] > {
    return: new HeadedIterator(new RangeHead(this /* : Tuple2 */.elements /* : unknown */.size /* : unknown */() /* : unknown */) /* : RangeHead */) /* : HeadedIterator */.map /* : (arg0 : (arg0 : T) => R) => Option<R> */((index) => new Tuple2Impl(index /* : T */, this /* : Tuple2 */.elements /* : unknown */.get /* : unknown */(index /* : T */) /* : unknown */) /* : Tuple2Impl */) /* : Option<R> */
};
/* @Override
        public */ removeFirst();
Option < [T, (List)] > {
...
/* private */ class ImmutableDefinition /*  */ {
    ...
    /* @Override
        public */ generateType() {
        if (this /* : Tuple2 */.type /* : unknown */.equals /* : unknown */(Unknown /* : unknown */) /* : unknown */) {
            return "";
        }
...
Option < R > {
    while() {
        if (this /* : Tuple2 */.current /* : unknown */.isPresent /* : unknown */() /* : unknown */) {
            let inner = this /* : Tuple2 */.current /* : unknown */.orElse /* : unknown */( /* null */) /* : unknown */;
        ...
        let outer = this /* : Tuple2 */.head /* : unknown */.next /* : unknown */() /* : unknown */;
...
Option < [CompileState, (List)] > {
    let, stringList = (input /* : string */, folder /* : (arg0 : R, arg1 : T) => R */) /* : unknown */
};
...
let definitions = segments /* : List<string> */.iterate /* : () => Iterator<T> */() /* : Iterator<T> */.map /* : (arg0 : (arg0 : T) => R) => Option<R> */(IncompleteClassSegment /* : IncompleteClassSegment */.createDefinition /* : unknown */) /* : Option<R> */.flatMap /* : (arg0 : (arg0 : T) => Option<R>) => Option<R> */(Iterators /* : Iterators */.fromOption /* : unknown */) /* : Option<R> */.collect /* : (arg0 : Collector<T, R>) => R */(new ListCollector() /* : ListCollector */) /* : R */;
let objectType = new ObjectType(name /* : () => string */, typeParams /* : () => List<string> */, definitions /* : List<Definition> */) /* : ObjectType */;
...
/* private static */ completeStructure(state, CompileState, targetInfix, string, beforeInfix, string, name, string, typeParams, (List), parameters, (List), after, string, segments, (List));
...
{
    segments /* : List<string> */.addFirst /* : (arg0 : string) => List<T> */(new Method(1 /* : number */, new ConstructorHeader() /* : ConstructorHeader */, parameters /* : List<Definition> */, new Some(Lists /* : Lists */.empty /* : () => List<T> */() /* : List<T> */) /* : Some */) /* : Method */) /* : List<T> */;
}
...
Option < [CompileState, Value] > {
    return: last /* : () => Option<T> */(input /* : string */, "instanceof", (s, s2) => {
        ...
        return /* parseDefinition */ (childTuple /* : [CompileState, Value] */[0 /* : number */]() /* : unknown */, s2 /* : unknown */) /* : unknown */.map /* : unknown */((definitionTuple) => {
            ...
            let variant = new DataAccess(value /* : T */, "_variant", Primitive /* : Primitive */.Unknown /* : unknown */) /* : DataAccess */;
            let type = value /* : T */.type /* : unknown */() /* : unknown */;
            let generate = type /* : () => Type */() /* : Type */.orElse /* : (arg0 : T) => T */("") /* : T */;
            let temp = new SymbolValue(generate /* : () => string */ + "Variant." + definition /* : unknown */.type /* : unknown */() /* : unknown */.findName /* : unknown */() /* : unknown */.orElse /* : unknown */("") /* : unknown */, Primitive /* : Primitive */.Unknown /* : unknown */) /* : SymbolValue */;
