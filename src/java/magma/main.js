...
/* public */ class Main /*  */ {
    ...
    parseStructureWithMaybeExtends(targetInfix, state, beforeInfix, beforeContent, content1, variants, annotations, interfaces) {
        return this /* : Main */.first /* : (arg0 : string, arg1 : string, arg2 : (arg0 : string, arg1 : string) => Option<T>) => Option<T> */(beforeContent /* : string */, " extends ", (s, s2) => {
            return this /* : Main */.parseValues /* : (arg0 : CompileState, arg1 : string, arg2 : (arg0 : CompileState, arg1 : string) => Option<[CompileState, T]>) => Option<[CompileState, List<T>]> */(state /* : CompileState */, s2 /* : unknown */, this /* : Main */.parseType /* : unknown */) /* : Option<[CompileState, List<T>]> */.flatMap /* : (arg0 : (arg0 : [CompileState, List<T>]) => Option<R>) => Option<R> */((inner) => {
    ...
    assembleStructure(state, targetInfix, annotations, beforeInfix, rawName, content, typeParams, after, rawParameters, variants, interfaces, maybeSuperType) {
        ...
        let prototype = new StructurePrototype(targetInfix /* : string */, beforeInfix /* : string */, name /* : unknown */, typeParams /* : List<string> */, parameters /* : List<Definition> */, after /* : string */, segments /* : unknown */, variants /* : List<string> */, interfaces /* : List<Type> */, maybeSuperType /* : List<Type> */) /* : StructurePrototype */;
    ...
    completeStructure(state, prototype) {
        ...
        let variantsSuper = bases /* : R */.query /* : unknown */() /* : unknown */.filter /* : unknown */((type) => type /* : unknown */.hasVariant /* : unknown */(prototype /* : StructurePrototype */.name /* : string */) /* : unknown */) /* : unknown */.map /* : unknown */(BaseType /* : BaseType */.findName /* : unknown */) /* : unknown */.collect /* : unknown */(new ListCollector() /* : ListCollector */) /* : unknown */;
    ...
    assembleInvokable(state, depth, argumentsString, callerString) {
        ...
        if (newCaller /* : Caller */._CallerVariant /* : unknown */ === CallerVariant.ConstructionCaller /* : unknown */) {
            if (constructionCaller /* : ConstructionCaller */.type /* : Type */.findName /* : unknown */() /* : unknown */ === "Tuple2Impl") {
    ...
    assembleDefinition(state, annotations, modifiers, rawName, typeParams, type) {
        return this /* : Main */.parseType /* : (arg0 : CompileState, arg1 : string) => Option<[CompileState, Type]> */(state /* : CompileState */.withTypeParams /* : (arg0 : List<string>) => CompileState */(typeParams /* : List<string> */) /* : CompileState */, type /* : string */) /* : Option<[CompileState, Type]> */.flatMap /* : (arg0 : (arg0 : [CompileState, Type]) => Option<R>) => Option<R> */((type1) => {
            ...
            let newModifiers = modifiers /* : List<string> */.query /* : () => Query<string> */() /* : Query<string> */.filter /* : (arg0 : (arg0 : string) => boolean) => Query<string> */((value) => !this /* : Main */.isAccessor /* : unknown */(value /* : string */) /* : unknown */) /* : Query<string> */.map /* : (arg0 : (arg0 : T) => R) => Option<R> */((modifier) =>  /* modifier.equals("final") ? "readonly" : modifier */) /* : Option<R> */.collect /* : (arg0 : Collector<T, R>) => R */(new ListCollector() /* : ListCollector */) /* : R */;
