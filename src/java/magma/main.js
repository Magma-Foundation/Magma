...
/* private static final */ class JVMList {
    ...
    /* @Override
        ...
        return new HeadedIterator(new RangeHead(elements.size( /*  */) /* : unknown */) /* : RangeHead */) /* : HeadedIterator */.map((index) => new /* Tuple */ ( /* index */, /* this */ .elements.get( /* index */) /* : unknown */) /* : content-start Tuple content-end */) /* : unknown */;
    }
    /* @Override
            public */ removeFirst() {
        /* if (this.elements.isEmpty())  */ {
...
/* private static */ class DivideState /*  */ {
    ...
    /* public */ pop() {
        /* if (this.index < this.input.length())  */ {
            ...
            return new Some(new /* Tuple */ ( /* c */, new DivideState(input, index + 1 /*  : number */, segments, buffer, depth) /* : DivideState */) /* : content-start Tuple content-end */) /* : Some */;
        }
        return new None( /*  */) /* : None */;
    }
    /* public */ popAndAppendToTuple() {
        return /* this */ .pop( /*  */) /* : unknown */.map((tuple) => new /* Tuple */ ( /* tuple */.left, /* tuple */ .right.append(left) /* : unknown */) /* : content-start Tuple content-end */) /* : unknown */;
    }
...
/* public */ class Main /*  */ {
    /* private */ CompileState(structures, definitions, types) {
        ...
        /* public CompileState withDefinitions(List<Definition> definitions)  */ {
            return new CompileState(structures, definitions /*  : List<Definition> */, types) /* : CompileState */;
        }
        ...
        /* public CompileState addType(ObjectType type)  */ {
            return new CompileState(structures, definitions, types.addLast( /* type */) /* : unknown */) /* : CompileState */;
        }
    }
    /* public static */ main() {
        /* try  */ {
    ...
    /* private static */ assemble(state, targetInfix, beforeInfix, rawName, content, typeParams, afterTypeParams, params) {
        ...
        return new Some(new Tuple(left.addStructure( /* generated */) /* : unknown */.addType(new ObjectType( /* name */) /* : ObjectType */) /* : unknown */, "") /* : Tuple */) /* : Some */;
    }
