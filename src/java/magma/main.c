...
/* private static String compileClassSegment(String input) {
        ...
        return "/* " + input + " */";
    } *//* } *//* public static final List<String> methods = new ArrayList<> */(/* ); *//* public static void main */(/* ) {
        try {
        ...
        } *//* return output.toString */(/* ); *//* var beforeClass = stripped.substring */(/* 0, classIndex); *//* var afterClass = stripped.substring */(/* classIndex + "class ".length()); *//* var contentStart = afterClass.indexOf */(/* "{");
            if (contentStart >= 0) {
