...
/* private static Option<Tuple<CompileState, */ /* String>> */ compileDefinitionWithoutTypeSeparator(/* CompileState */ instance, /* String */ type, /* String */ name){/* var generated = generatePlaceholder(type) + " " + name.strip(); *//* return new Some<>(new Tuple<CompileState, String>(instance, generated)); *//*  */
}
