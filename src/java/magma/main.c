...
/* private */struct InfixLocator(String infix, BiFunction<String, String, Option<Integer>> locator) implements Locator {
};
/* public */struct Main {/* 
...
/* private static class TypeSeparatorLocator implements Locator {
        @Override
        public */ /* Option<Tuple<String, String>> */ split(/*  */ /* String */ input){/* return divide(input, TypeSeparatorLocator::fold).removeLast().map(segments -> {
...
/* private static */ /* Option<Tuple<CompileState, String>> */ definition(/*  */ /* CompileState */ state, /*  */ /* String */ input){/* return infix(input.strip(), new InfixLocator(" ", Main::lastIndexOfSlice), (beforeName, name) -> {
            if (!isSymbol(name)) {
                return new None<>();
            }
...
/* private static */ /* Option<Tuple<CompileState, String>> */ definitionWithTypeSeparator(/*  */ /* CompileState */ instance, /*  */ /* String */ beforeName, /*  */ /* String */ name){/* return infix(beforeName, new TypeSeparatorLocator(), (beforeType, typeString) -> {
