...
/* private static String getString(String input) */{/* return compileAll(input, Main::compileClassSegment); */}
...
/* return generatePlaceholder(stripped);
    ...
    private static String compileFunctionSegment(String input) */{/* return generatePlaceholder(input.strip());
    }
