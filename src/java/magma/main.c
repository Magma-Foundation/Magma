...
/* public *//* static <T> Option<Integer> */ indexOf(/* List_<T> */ list, T element, int (*)(T, T) equator){
...
/* private *//* static boolean */ isDefined(/* List_<Tuple<String, List_<String>>> */ toExpand, Tuple__String_/* List_<String> */__ tuple){
