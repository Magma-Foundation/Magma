...
/* @Override
	...
	/* Function<T */;, 
	/* R> */ mapper;){/* return new Some<>(mapper.apply(this.value)); *//*  */
}
/* @Override
...
/* @Override
        public */ /* T */ orElse(
	/* T */ other;){/* return this.value; *//*  */
}
/* @Override
        public */ /* Option<T> */ or(
	/* Supplier<Option<T>> */ other;){/* return this; *//*  */
}
/* @Override
        public */ /* T */ orElseGet(
	/* Supplier<T> */ other;){/* return this.value; *//*  */
}
/* @Override
        public <R> */ /* Option<R> */ flatMap(
	/* Function<T */;, 
	/* Option<R>> */ mapper;){/* return mapper.apply(this.value); *//*  */
}
/* public */ /* T */ get(
	/*  */;){/* return this.value; *//*  */
}
...
/* @Override
        public */ /* T */ orElse(
	/* T */ other;){/* return other; *//*  */
}
/* @Override
        public */ /* Option<T> */ or(
	/* Supplier<Option<T>> */ other;){/* return other.get(); *//*  */
}
/* @Override
        public */ /* T */ orElseGet(
	/* Supplier<T> */ other;){/* return other.get(); *//*  */
}
/* @Override
        public <R> */ /* Option<R> */ flatMap(
	/* Function<T */;, 
	/* Option<R>> */ mapper;){/* return new None<>(); *//*  */
}
/* public <C> */ /* C */ collect(
	/* Collector<T */;, 
	/* C> */ collector;){/* return this.fold(collector.createInitial(), collector::fold); *//*  */
}
/* private <C> */ /* C */ fold(
	/* C */ initial;, 
	/*  BiFunction<C */;, 
	/*  T */;, 
	/* C> */ folder;){/* var current = initial; *//* while (true) {
...
/* public <R> */ /* Iterator<R> */ flatMap(
	/* Function<T */;, 
	/* Iterator<R>> */ mapper;){/* return this.map(mapper).fold(new Iterator<>(new EmptyHead<>()), Iterator::concat); *//*  */
}
/* public <R> */ /* Iterator<R> */ map(
	/* Function<T */;, 
	/* R> */ mapper;){/* return new Iterator<>(() -> this.head.next().map(mapper)); *//*  */
}
/* private */ /* Iterator<T> */ concat(
	/* Iterator<T> */ other;){/* return new Iterator<>(() -> this.head.next().or(other::next)); *//*  */
}
...
/* private static class Lists {
	...
	/* T... */ elements;){/* return new JavaList<>(Arrays.asList(elements)); *//* }
...
/* private */ /* String */ getJoin(
	/* List<String> */ lists;){/* return lists.iterate().collect(new Joiner()).orElse(""); *//*  */
}
/* public */ /* CompileState */ addStruct(
	/* String */ struct;){/* return new CompileState(this.structs.addLast(struct), this.functions); *//*  */
}
/* public */ /* CompileState */ addFunction(
	/* String */ function;){/* return new CompileState(this.structs, this.functions.addLast(function)); *//*  */
}
/* public */ DivideState(
	/* String */ input;){/* this(input, new JavaList<>(), new StringBuilder(), 0, 0); *//*  */
}
...
/* private */ /* DivideState */ append(
	/* char */ c;){/* return new DivideState(this.input, this.segments, this.buffer.append(c), this.index, this.depth); *//*  */
}
...
/* private static class Iterators {
        public static <T> */ /* Iterator<T> */ fromOptions(
	/* Option<T> */ option;){/* return new Iterator<>(option.<Head<T>>map(SingleHead::new).orElseGet(EmptyHead::new)); *//* } */
}
...
/* private static */ /* String */ compileRoot(
	/* String */ input;){/* var state = new CompileState(); *//* var tuple = compileAll(state, input, Main::compileRootSegment)
...
/* private static Option<Tuple<CompileState, */ /* String>> */ compileAll(
	...
	/* String */ input;, 
	/* 
            BiFunction<CompileState */;, 
	/*  String */;, 
	/*  Option<Tuple<CompileState */;, 
	/* String>>> */ mapper;){/* return compileAll(initial, input, Main::foldStatementChar, mapper, Main::mergeStatements); *//*  */
}
/* private static Option<Tuple<CompileState, */ /* String>> */ compileAll(
	/* CompileState */ initial;, 
	/* String */ input;, 
	/* 
            BiFunction<DivideState */;, 
	/*  Character */;, 
	/* DivideState> */ folder;, 
	/*  BiFunction<CompileState */;, 
	/*  String */;, 
...
/* private static Option<Tuple<CompileState, */ /* StringBuilder>> */ foldElement(
	...
	/* 
            BiFunction<StringBuilder */;, 
	/*  String */;, 
	/* StringBuilder> */ merger;){/* var oldState = state.left; *//* var oldCache = state.right; *//* return mapper.apply(oldState, segment).map(result -> {
            var newState = result.left;
            var newElement = result.right;
            return new Tuple<>(newState, merger.apply(oldCache, newElement));
        } *//* ); *//*  */
}
/* private static */ /* StringBuilder */ mergeStatements(
	/* StringBuilder */ output;, 
	/* String */ right;){/* return output.append(right); *//*  */
}
/* private static */ /* List<String> */ divide(
	/* String */ input;, 
	/*  BiFunction<DivideState */;, 
	/*  Character */;, 
	/* DivideState> */ folder;){/* DivideState current = new DivideState(input); *//* while (true) {
...
/* private static */ /* Option<DivideState> */ foldDoubleQuotes(
	/* DivideState */ state;, 
	/* char */ c;){/* if (c != '\"') {
            return new None<>();
...
/* private static */ /* DivideState */ foldStatementChar(
	/* DivideState */ state;, 
	/* char */ c;){/* var appended = state.append(c); *//* if (c == ';' && appended.isLevel()) {
...
/* private static Option<Tuple<CompileState, */ /* String>> */ compileRootSegment(
	/* CompileState */ state;, 
	/* String */ input;){/* return or(state, input, Lists.of(
                Main::whitespace,
...
/* private static BiFunction<CompileState, String, Option<Tuple<CompileState, */ /* String>>> */ structure(
	/* String */ infix;){/* return (state, input) -> first(input, infix, (beforeKeyword, afterKeyword) -> {
...
/* private static Option<Tuple<CompileState, */ /* String>> */ structureWithParams(
	/* String */ beforeKeyword;, 
	/* String */ withEnd;, 
	/* CompileState */ instance;, 
	/* String */ before;){/* return suffix(before.strip(), ")", withoutEnd -> first(withoutEnd, "(", (name, paramString) -> {
...
/* private static Option<Tuple<CompileState, */ /* String>> */ params(
	/* CompileState */ state;, 
	/* String */ input;, 
	/*  BiFunction<StringBuilder */;, 
	/*  String */;, 
	/* StringBuilder> */ merger;){/* return compileAll(state, input, Main::foldValueChar, Main::compileParameter, merger); *//*  */
}
/* private static */ /* StringBuilder */ mergeValues(
	/* StringBuilder */ buffer;, 
	/* String */ element;){/* if (buffer.isEmpty()) {
            return buffer.append(element);
        } *//* return buffer.append(", ").append(element); *//*  */
}
/* private static Option<Tuple<CompileState, */ /* String>> */ compileParameter(
	/* CompileState */ instance;, 
	/* String */ paramString;){/* return or(instance, paramString, Lists.of(
                Main::definition,
                Main::content
        )).map(value -> new Tuple<>(value.left, "\n\t" + value.right + ";")); *//*  */
}
/* private static */ /* DivideState */ foldValueChar(
	/* DivideState */ state;, 
	/* char */ c;){/* if (c == ',') {
...
/* private static Option<Tuple<CompileState, */ /* String>> */ or(
	...
	/* String */ input;, 
	/* 
            List<BiFunction<CompileState */;, 
	/*  String */;, 
	/*  Option<Tuple<CompileState */;, 
	/* String>>>> */ actions;){/* return actions.iterate()
...
/* private static Option<Tuple<CompileState, */ /* String>> */ definitionStatement(
	/* CompileState */ state;, 
	/* String */ input;){/* return suffix(input.strip(), ";", withoutEnd -> definition(state, withoutEnd).map(value -> {
            var generated = "\n\t" + value.right + ";";
...
/* private static Option<Tuple<CompileState, */ /* String>> */ method(
	/* CompileState */ state;, 
	/* String */ input;){/* return first(input, "(", (inputDefinition, withParams) -> {
...
/* private static Option<Tuple<CompileState, */ /* String>> */ methodWithContent(
	/* CompileState */ state;, 
	/* String */ outputDefinition;, 
	/* String */ params;, 
	/* String */ withBraces;){/* return prefix(withBraces.strip(), "{", withoutStart1 -> {
...
/* private static Option<Tuple<CompileState, */ /* String>> */ compileMethodHeader(
	/* CompileState */ state;, 
	/* String */ definition;){/* return or(state, definition, Lists.of(
                Main::definition,
                Main::content
        )); *//*  */
}
/* private static Option<Tuple<CompileState, */ /* String>> */ compileFunctionSegment(
	/* CompileState */ state;, 
	/* String */ input;){/* return or(state, input.strip(), Lists.of(
                Main::content
        )); *//*  */
}
...
/* private static Option<Tuple<CompileState, */ /* String>> */ prefix(
	...
	/*  Function<String */;, 
	/*  Option<Tuple<CompileState */;, 
	/* String>>> */ mapper;){/* if (!input.startsWith(prefix)) {
            return new None<>();
        } *//* var slice = input.substring(prefix.length()); *//* return mapper.apply(slice); *//*  */
}
/* private static <T> */ /* Option<T> */ suffix(
	/* String */ input;, 
	/* String */ suffix;, 
	/*  Function<String */;, 
	/* Option<T>> */ mapper;){/* if (!input.endsWith(suffix)) {
            return new None<>();
...
/* private static <T> */ /* Option<T> */ first(
	/* String */ input;, 
	/* String */ infix;, 
	/*  BiFunction<String */;, 
	/*  String */;, 
	/* Option<T>> */ mapper;){/* return infix(input, infix, Main::firstIndexOfSlice, mapper); *//*  */
}
/* private static <T> */ /* Option<T> */ infix(
	...
	/*  BiFunction<String */;, 
	/*  String */;, 
	/* Option<Integer>> */ locator;, 
	/*  BiFunction<String */;, 
	/*  String */;, 
	/* Option<T>> */ mapper;){/* return locator.apply(input, infix).flatMap(classIndex -> {
