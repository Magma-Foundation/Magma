...
auto iterWithIndices_local1(auto Tuple<Integer, auto String> input){
	/* expectedArgumentsType.find(expectedArgumentsType, input.left) */ maybeFound = expectedArgumentsType.find(expectedArgumentsType, input.left);
	/* Value parsed; */
