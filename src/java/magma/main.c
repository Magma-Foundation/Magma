...
// #include <temp.h>
// #include <temp.h>
struct Main {struct State {/* private final List<String> segments; *//* private int depth; *//* private StringBuilder buffer; *//* private State(List<String> segments, StringBuilder buffer, int depth) {
