...
/* private */struct CompileState {/* List<String> */ structs/* List<String> */ functions
};
/* private */struct DivideState {/* String */ input/* List<String> */ segments/* StringBuilder */ buffer/* int */ index/* int */ depth
};
...
/* @Override
 public */ /* Option<String> */ fold(/* Option<String> */ current, /* String */ element){/* return new Some<>(current.map(inner -> inner + this.delimiter + element).orElse(element)); *//*  */
}
...
/* @Override
 public */ /* Option<Tuple<String, String>> */ split(/* String */ input){/* return this.apply(input).map(classIndex -> {
...
/* private */ /* Option<Integer> */ apply(/* String */ input){/* return this.locator().apply(input, this.infix); *//*  */
}
/* private static class TypeSeparatorSplitter implements Splitter {
 @Override
 public */ /* Option<Tuple<String, String>> */ split(/* String */ input){/* return divide(input, TypeSeparatorSplitter::fold).removeLast().flatMap(segments -> {
...
/* private static */ /* Option<Tuple<CompileState, String>> */ content(/* CompileState */ state, /* String */ input){/* return new Some<>(new Tuple<CompileState, String>(state, generatePlaceholder(input))); *//*  */
}
...
/* private static */ /* Option<Tuple<CompileState, String>> */ definition(/* CompileState */ state, /* String */ input){/* return infix(input.strip(), new InfixSplitter(" ", Main::lastIndexOfSlice), (beforeName, name) -> {
            if (!isSymbol(name)) {
                return new None<>();
            }
...
/* private static <T> */ /* Option<T> */ first(/* String */ input, /* String */ infix, /* BiFunction<String, String, Option<T>> */ mapper){/* return infix(input, new InfixSplitter(infix, Main::firstIndexOfSlice), mapper); *//*  */
}
/* private static <T> */ /* Option<T> */ infix(/* String */ input, /* Splitter */ splitter, /* BiFunction<String, String, Option<T>> */ mapper){/* return splitter.split(input).flatMap(tuple -> {
            return mapper.apply(tuple.left, tuple.right);
        } *//* ); *//*  */
}
/* private static */ /* Option<Integer> */ firstIndexOfSlice(/* String */ input, /* String */ infix){/* var index = input.indexOf(infix); *//* return index == -1 ? new None<Integer>() : new Some<>(index); *//*  */
}
