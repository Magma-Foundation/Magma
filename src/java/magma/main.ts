...
/* private */class HeadedIterator<T>/*  */ {
	...
	/* @Override
		...
		return new HeadedIterator(new FlatMapHead(/* this */.head, f/*  : (arg0 : T) => Iterator<R> */)/* : FlatMapHead */)/* : HeadedIterator */;
	}
}
...
/* private static final */class JVMList<T>/*  */ {
	...
	/* @Override
		...
		return new HeadedIterator(new RangeHead(/* this */.elements.size(/*  */)/* : unknown */)/* : RangeHead */)/* : HeadedIterator */.map((index : unknown) => new Tuple(/* index */, /* this */.elements.get(/* index */)/* : unknown */)/* : Tuple */)/* : unknown */;
	}
	/* @Override
...
/* private static */class Lists/*  */ {
	...
	/* public static  */ of<T>(elements : T[]) : List<T> {
		return new JVMList(new ArrayList(/* Arrays */.asList(elements/*  : T[] */)/* : unknown */)/* : ArrayList */)/* : JVMList */;
	}
}
/* private static */class DivideState/*  */ {
	...
	/* public */ pop() : Option<[Character, DivideState]> {
		/* if (this.index < this.input.length())  */{
			...
			return new Some(new Tuple(/* c */, new DivideState(/* this */.input, /* this */.index + 1/*  : number */, /* this */.segments, /* this */.buffer, /* this */.depth)/* : DivideState */)/* : Tuple */)/* : Some */;
		}
		return new None(/*  */)/* : None */;
	}
	/* public */ popAndAppendToTuple() : Option<[Character, DivideState]> {
		return /* this */.pop(/*  */)/* : unknown */.map((tuple : unknown) => new Tuple(/* tuple */.left, /* tuple */.right.append(/* tuple */.left)/* : unknown */)/* : Tuple */)/* : unknown */;
	}
...
/* public */class Main/*  */ {/* 
	...
	/* private */ CompileState(structures : List<string>, definitions : List<Definition>) : record {
		...
		/* public CompileState addStructure(String structure)  */{
			return new CompileState(/* this */.structures.addLast(/* structure */)/* : unknown */, /* this */.definitions)/* : CompileState */;
		}
		/* public CompileState withDefinitions(List<Definition> definitions)  */{
			return new CompileState(/* this */.structures, definitions/*  : List<Definition> */)/* : CompileState */;
		}
	}
	...
	/* private static */ assemble(state : CompileState, targetInfix : string, beforeInfix : string, rawName : string, content : string, typeParams : List<string>, afterTypeParams : string, params : List<Parameter>) : Option<[CompileState, string]> {
		...
		return new Some(new Tuple(/* parsed */.left.addStructure(/* generated */)/* : unknown */, "")/* : Tuple */)/* : Some */;
	}
	...
	/* private static */ assembleTemplate(base : string, strippedBase : string, state : CompileState, arguments : List<Argument>) : [CompileState, Type] {
		...
		return new Tuple(state/*  : CompileState */, new Template(strippedBase/*  : string */, /* children */)/* : Template */)/* : Tuple */;
	}
