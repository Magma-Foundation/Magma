...
/* private */class ImmutableDefinition/*  */ implements Definition {
	...
	joinModifiers() : string {
		return this/* : ImmutableDefinition */.modifiers/* : List<string> */.query/* : () => Query<string> */()/* : Query<string> */.map/* : (arg0 : (arg0 : string) => R) => Query<R> */((value : string) => value/* : string */ + " ")/* : Query<R> */.collect/* : (arg0 : Collector<T, R>) => R */(new Joiner("")/* : Joiner */)/* : R */.orElse/* : unknown */("")/* : unknown */;
	}
	...
	public generateWithParams(joinedParameters : string) : string {
		let joinedAnnotations = this/* : ImmutableDefinition */.annotations/* : List<string> */.query/* : () => Query<string> */()/* : Query<string> */.map/* : (arg0 : (arg0 : string) => R) => Query<R> */((value : string) => "@" + value + " ")/* : Query<R> */.collect/* : (arg0 : Collector<T, R>) => R */(Joiner/* : Joiner */.empty/* : () => Joiner */()/* : Joiner */)/* : R */.orElse/* : unknown */("")/* : unknown */;
...
/* private */class ObjectType/*  */ implements FindableType, BaseType {
	...
	public replace(mapping : Map<string, Type>) : Type {
		return new ObjectType(this/* : ObjectType */.name/* : string */, this/* : ObjectType */.typeParams/* : List<string> */, this/* : ObjectType */.definitions/* : List<Definition> */.query/* : () => Query<Definition> */()/* : Query<Definition> */.map/* : (arg0 : (arg0 : Definition) => R) => Query<R> */((definition : Definition) => definition/* : Definition */.mapType/* : (arg0 : (arg0 : Type) => Type) => Definition */((type : Type) => type/* : Type */.replace/* : unknown */(mapping/* : Map<string, Type> */)/* : unknown */)/* : Definition */)/* : Query<R> */.collect/* : (arg0 : Collector<T, R>) => R */(new ListCollector()/* : ListCollector */)/* : R */, this/* : ObjectType */.variants/* : List<string> */)/* : ObjectType */;
	}
	public find(name : string) : Option<Type> {
		return this/* : ObjectType */.definitions/* : List<Definition> */.query/* : () => Query<Definition> */()/* : Query<Definition> */.filter/* : (arg0 : (arg0 : Definition) => boolean) => Query<Definition> */((definition : Definition) => definition/* : Definition */.findName/* : () => string */()/* : string */ === name/* : string */)/* : Query<Definition> */.map/* : (arg0 : (arg0 : T) => R) => Option<R> */(Definition/* : Definition */.findType/* : unknown */)/* : Option<R> */.next/* : () => Option<T> */()/* : Option<T> */;
	}
...
/* private */class CompileState/*  */ {
	...
	resolveValue(name : string) : Option<Type> {
		return this/* : CompileState */.definitions/* : List<List<Definition>> */.iterateReversed/* : () => Query<List<Definition>> */()/* : Query<List<Definition>> */.flatMap/* : (arg0 : (arg0 : List<Definition>) => Query<R>) => Query<R> */(List/* : List */.query/* : unknown */)/* : Query<R> */.filter/* : (arg0 : (arg0 : T) => boolean) => Option<T> */((definition : T) => definition/* : T */.findName/* : unknown */()/* : unknown */ === name/* : string */)/* : Option<T> */.next/* : () => Option<T> */()/* : Option<T> */.map/* : (arg0 : (arg0 : T) => R) => Option<R> */(Definition/* : Definition */.findType/* : unknown */)/* : Option<R> */;
	}
	...
	public resolveType(name : string) : Option<Type> {
		...
		let maybeTypeParam : Option<T> = this/* : CompileState */.typeParams/* : List<string> */.query/* : () => Query<string> */()/* : Query<string> */.filter/* : (arg0 : (arg0 : string) => boolean) => Query<string> */((param : string) => param/* : string */ === name/* : string */)/* : Query<string> */.next/* : () => Option<T> */()/* : Option<T> */;
		...
		return this/* : CompileState */.objectTypes/* : List<ObjectType> */.query/* : () => Query<ObjectType> */()/* : Query<ObjectType> */.filter/* : (arg0 : (arg0 : ObjectType) => boolean) => Query<ObjectType> */((type : ObjectType) => type/* : ObjectType */.name/* : string */ === name/* : string */)/* : Query<ObjectType> */.next/* : () => Option<T> */()/* : Option<T> */.map/* : (arg0 : (arg0 : T) => R) => Option<R> */((type : T) => type/* : ObjectType */)/* : Option<R> */;
	}
...
/* private */class FunctionType/*  */ implements Type {
	...
	public replace(mapping : Map<string, Type>) : Type {
		return new FunctionType(this/* : FunctionType */.arguments/* : List<Type> */.query/* : () => Query<Type> */()/* : Query<Type> */.map/* : (arg0 : (arg0 : Type) => R) => Query<R> */((type : Type) => type/* : Type */.replace/* : unknown */(mapping/* : Map<string, Type> */)/* : unknown */)/* : Query<R> */.collect/* : (arg0 : Collector<T, R>) => R */(new ListCollector()/* : ListCollector */)/* : R */, this/* : FunctionType */.returns/* : Type */.replace/* : unknown */(mapping/* : Map<string, Type> */)/* : unknown */)/* : FunctionType */;
	}
	public findName() : string {
		return "";
	}
...
/* private */class Template/*  */ implements FindableType {
	...
	public replace(mapping : Map<string, Type>) : Type {
		let collect : R = this/* : Template */.arguments/* : List<Type> */.query/* : () => Query<Type> */()/* : Query<Type> */.map/* : (arg0 : (arg0 : Type) => R) => Query<R> */((argument : Type) => argument/* : Type */.replace/* : unknown */(mapping/* : Map<string, Type> */)/* : unknown */)/* : Query<R> */.collect/* : (arg0 : Collector<T, R>) => R */(new ListCollector()/* : ListCollector */)/* : R */;
...
/* private */class StructurePrototype/*  */ implements IncompleteClassSegment {
	...
	createObjectType() : ObjectType {
		let definitionFromSegments : R = this/* : StructurePrototype */.segments/* : List<IncompleteClassSegment> */.query/* : () => Query<IncompleteClassSegment> */()/* : Query<IncompleteClassSegment> */.map/* : (arg0 : (arg0 : IncompleteClassSegment) => R) => Query<R> */(IncompleteClassSegment/* : IncompleteClassSegment */.maybeCreateDefinition/* : unknown */)/* : Query<R> */.flatMap/* : (arg0 : (arg0 : T) => Option<R>) => Option<R> */(Queries/* : Queries */.fromOption/* : unknown */)/* : Option<R> */.collect/* : (arg0 : Collector<T, R>) => R */(new ListCollector()/* : ListCollector */)/* : R */;
...
/* public */class Main/*  */ {
	...
	parseStructureWithMaybePermits(targetInfix : string, state : CompileState, beforeInfix : string, beforeContent : string, content1 : string, annotations : List<string>) : Option<[CompileState, IncompleteClassSegment]> {
		return this/* : Main */.last/* : (arg0 : string, arg1 : string, arg2 : (arg0 : string, arg1 : string) => Option<T>) => Option<T> */(beforeContent/* : string */, " permits ", (s, s2) => {
			let variants : R = this/* : Main */.divideAll/* : (arg0 : string, arg1 : (arg0 : DivideState, arg1 : string) => DivideState) => List<string> */(s2/* : unknown */, this/* : Main */.foldValueChar/* : unknown */)/* : List<string> */.query/* : () => Query<string> */()/* : Query<string> */.map/* : (arg0 : (arg0 : string) => R) => Query<R> */(/* String */.strip/* : unknown */)/* : Query<R> */.filter/* : (arg0 : (arg0 : T) => boolean) => Option<T> */((value : T) => !value/* : T */.isEmpty/* : unknown */()/* : unknown */)/* : Option<T> */.collect/* : (arg0 : Collector<T, R>) => R */(new ListCollector()/* : ListCollector */)/* : R */;
	...
	parseLambda(state : CompileState, input : string, depth : number) : Option<[CompileState, Value]> {
		return this/* : Main */.first/* : (arg0 : string, arg1 : string, arg2 : (arg0 : string, arg1 : string) => Option<T>) => Option<T> */(input/* : string */, "->", (beforeArrow, valueString) => {
			...
			if (strippedBeforeArrow/* : unknown */.startsWith/* : unknown */("(")/* : unknown */ && strippedBeforeArrow/* : unknown */.endsWith/* : unknown */(")")/* : unknown */){
				let parameterNames : R = this/* : Main */.divideAll/* : (arg0 : string, arg1 : (arg0 : DivideState, arg1 : string) => DivideState) => List<string> */(strippedBeforeArrow/* : unknown */.substring/* : unknown */(1/* : number */, Strings/* : Strings */.length/* : (arg0 : string) => number */(strippedBeforeArrow/* : unknown */)/* : number */ - 1/* : number */)/* : unknown */, this/* : Main */.foldValueChar/* : unknown */)/* : List<string> */.query/* : () => Query<string> */()/* : Query<string> */.map/* : (arg0 : (arg0 : string) => R) => Query<R> */(/* String */.strip/* : unknown */)/* : Query<R> */.filter/* : (arg0 : (arg0 : T) => boolean) => Option<T> */((value : T) => !value/* : T */.isEmpty/* : unknown */()/* : unknown */)/* : Option<T> */.map/* : (arg0 : (arg0 : T) => R) => Option<R> */((name : T) => ImmutableDefinition/* : ImmutableDefinition */.createSimpleDefinition/* : (arg0 : string, arg1 : Type) => Definition */(name/* : T */, Primitive/* : Primitive */.Unknown/* : unknown */)/* : Definition */)/* : Option<R> */.collect/* : (arg0 : Collector<T, R>) => R */(new ListCollector()/* : ListCollector */)/* : R */;
	...
	assembleDefinition(state : CompileState, annotations : List<string>, modifiers : List<string>, rawName : string, typeParams : List<string>, type : string) : Option<[CompileState, Definition]> {
		return this/* : Main */.parseType/* : (arg0 : CompileState, arg1 : string) => Option<[CompileState, Type]> */(state/* : CompileState */.withTypeParams/* : (arg0 : List<string>) => CompileState */(typeParams/* : List<string> */)/* : CompileState */, type/* : string */)/* : Option<[CompileState, Type]> */.flatMap/* : (arg0 : (arg0 : [CompileState, Type]) => Option<R>) => Option<R> */((type1 : [CompileState, Type]) => {
			...
			let newModifiers : R = modifiers/* : List<string> */.query/* : () => Query<string> */()/* : Query<string> */.filter/* : (arg0 : (arg0 : string) => boolean) => Query<string> */((value : string) => !this/* : Main */.isAccessor/* : unknown */(value/* : string */)/* : unknown */)/* : Query<string> */.map/* : (arg0 : (arg0 : T) => R) => Option<R> */((modifier : T) => /* modifier.equals("final") ? "readonly" : modifier */)/* : Option<R> */.collect/* : (arg0 : Collector<T, R>) => R */(new ListCollector()/* : ListCollector */)/* : R */;
	...
	assembleTemplate(base : string, state : CompileState, arguments : List<Argument>) : [CompileState, Type] {
		let children : R = arguments/* : List<Argument> */.query/* : () => Query<Argument> */()/* : Query<Argument> */.map/* : (arg0 : (arg0 : Argument) => R) => Query<R> */(this/* : Main */.retainType/* : unknown */)/* : Query<R> */.flatMap/* : (arg0 : (arg0 : T) => Option<R>) => Option<R> */(Queries/* : Queries */.fromOption/* : unknown */)/* : Option<R> */.collect/* : (arg0 : Collector<T, R>) => R */(new ListCollector()/* : ListCollector */)/* : R */;
