...
public final class StagedCompiler<R extends Serializable> implements Compiler {
    private final Parser<JavaLang.JavaRoot, R> parser;
    private final Generator generator;

    public StagedCompiler(Parser<JavaLang.JavaRoot, R> parser, Generator generator) {
        this.parser = parser;
        this.generator = generator;
    }

    @Override
    public CompileResult<UnitSet<String>> parseAndGenerate(UnitSet<JavaLang.JavaRoot> units) {
