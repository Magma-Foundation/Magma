...
import jvm.io.Paths;class import jvm.io.Paths;{
import jvm.io.Paths;
import jvm.process.Processes;class import jvm.process.Processes;{
import jvm.process.Processes;
import magma.collect.Joiner;class import magma.collect.Joiner;{
import magma.collect.Joiner;
import magma.collect.list.List_;class import magma.collect.list.List_;{
import magma.collect.list.List_;
import magma.collect.set.SetCollector;class import magma.collect.set.SetCollector;{
...
import magma.compile.Compiler;class import magma.compile.Compiler;{
import magma.compile.Compiler;
import magma.compile.source.PathSource;class import magma.compile.source.PathSource;{
import magma.compile.source.PathSource;
import magma.compile.source.Source;class import magma.compile.source.Source;{
