...
return new TypeRule(, CommonLang.createBlockRule(createCRootSegmentRule()));}
...
StringRule name = new StringRule();
...
NodeRule returns = new NodeRule(, createTypeRule());
...
NodeListRule path = new NodeListRule(, new CharDivider(), new StringRule());
