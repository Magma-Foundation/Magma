...
- **Fix general formatting and style issues** – avoid unqualified static method calls, clean up unused imports, and follow consistent parameter naming conventions.
